...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.ccghy4gsqr4j.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstones3mehmetblog' # please enter your s3 bucket name
